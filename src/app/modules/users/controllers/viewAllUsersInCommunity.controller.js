...
exports.viewAllUsers = async (req, res, next) => {
  ...
  const users = await new UserService().all(req.query.limit, req.query.page, data);
    let resMessage = req.query.type ?  `Users of type ${req.query.type} retrieved` : "All Users Info Fetched"
